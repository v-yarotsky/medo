Feature: Add note to task
  ...
  Scenario: Add todo
    ...
    And I successfully run `medo --tasks-file=/tmp/test-medo-tasks note -n 1 "Trash the PC"`
    And I successfully run `medo --tasks-file=/tmp/test-medo-tasks note -n 2 The Note`
